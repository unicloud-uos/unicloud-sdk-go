...
//		InstanceCode: "SLB",
//		InstanceName: "opennnn1",
//		OrderCategory: "NEW",
//		PayType: "DAY_MONTH",
//		ProductDescription: st,
...
type DeleteLoadBalancerRequest struct {
	*tchttp.BaseRequest
	...
	//Ids []string `json:"LoadBalancerIds,omitempty" name:"LoadBalancerIds" list`
}
...
type DescribeLoadBalancersResponse struct {
	*tchttp.BaseResponse
	...
	Res struct{
		...
		Data []DescribeSlbArg `json:"Data"`
	} `json:"Res`
	RequestId string `json:"RequestId"`
}

type DescribeSlbArg struct {
